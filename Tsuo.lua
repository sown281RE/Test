...
local Fluent = loadstring(game:HttpGet("https://raw.githubusercontent.com/hnc-roblox/ThemeOr/refs/heads/main/main.lua"))()
...
local Window = Fluent:CreateWindow({
    ...
    TabWidth = 120,
    Size = UDim2.fromOffset(455, 320),
    Acrylic = false,
    Theme = "Aqua",
    MinimizeKey = Enum.KeyCode.End -- bấm phím End để bật/tắt menu
})

local Tabs = {
    Home = Window:AddTab({Title = "Home", Icon = ""}),
    Main = Window:AddTab({Title = "Main", Icon = ""}),
    Fishing = Window:AddTab({Title = "Fishing", Icon = ""}),-- add vô tab này dùm t
    ...
    Mirage = Window:AddTab({Title = "Race V4", Icon = ""}),
    Drago = Window:AddTab({Title = "Dragon Dojo", Icon = ""}),
    Prehistoric = Window:AddTab({Title = "Prehistoric", Icon = ""}),
    Raids = Window:AddTab({Title = "Raid", Icon = ""}),
    Combat = Window:AddTab({Title = "PVP", Icon = ""}),
...
-- Check PC/Mobile + Notify
local IsPc = not game:GetService("UserInputService").TouchEnabled
local executor = tostring(identifyexecutor())

if IsPc then
    if not string.find(executor, "Wave") and not string.find(executor, "AWP") then
        Fluent:Notify({
            Title = "HNC Hub",
            Content = "Finished Loading",
            SubContent = "By HNC Roblox",
            Duration = 15
        })
    else
        Fluent:Notify({
            Title = "HNC Hub",
            Content = "By HNC Roblox",
            SubContent = "Anti Ban Enabled",
            Duration = 15
        })
    end
else
    Fluent:Notify({
        Title = "HNC Hub",
        Content = "Attack/M1",
        SubContent = "Fast Attack Enabled",
        Duration = 15
    })
end
Tabs.Home:AddButton({
...
local FarmLevel = Tabs.Main:AddToggle("FarmLevel", {Title = "Auto Farm Level", Description = "Tự động cày cấp", Default = false})
...
local TravelDress = Tabs.Main:AddToggle("TravelDress", {Title = "Auto TP Dressrosa", Description = "Tự động tp đến Dressrosa", Default = false})
...
local Zou = Tabs.Main:AddToggle("Zou", {Title = "Auto Get Quest", Description = "Tự động nhận nhiệm vụ gần", Default = false})
...
local ClosetMons = Tabs.Main:AddToggle("ClosetMons", {Title = "Auto Farm Nearest", Description = "Tự động cày quái gần", Default = false})
...
local FactoryRaids = Tabs.Main:AddToggle("FactoryRaids", {Title = "Auto Factory Raid", Description = "Tự động đánh nhà máy", Default = false})
...
local CastleRaids = Tabs.Main:AddToggle("CastleRaids", {Title = "Auto Pirate Raid", Description = "Tự động đánh hải tặc", Default = false})
...
Toggle = Tabs.Main:AddToggle("Toggle", {Title = "Auto Materials", Description = "Tự động cày vật liệu", Default = false})
...
local Q = Tabs.Main:AddToggle("Q", {Title = "Auto Farm Ectoplasm", Description = "Tự động cày vật chất huyền bí", Default = false})
...
local Bartilo = Tabs.Main:AddToggle("Bartilo", {Title = "Auto Done Bartilo Quest", Description = "Tự động nhiệm vụ Bartilo", Default = false})
...
local CitizenQ = Tabs.Main:AddToggle("CitizenQ", {Title = "Auto Done Citizen Quest", Description = "Tự động nhiệm vụ Citizen", Default = false})
...
local Q = Tabs.Main:AddToggle("Q", {Title = "Auto Training Dummy", Description = "Tự động Training Dummy", Default = false})
Q:OnChanged(function(Value)
  _G.DummyMan = Value
end)
spawn(function()
...
local Berry = Tabs.Main:AddToggle("Berry", {Title = "Auto Collect Berry", Description = "Nhặt Berry", Default = false})
...
local Chest = Tabs.Main:AddToggle("Chest", {Title = "Auto Collect Chest", Description = "Lụm rương", Default = false})
...
local MasteryFruits = Tabs.Main:AddToggle("MasteryFruits", {Title = "Auto Mastery Fruits", Description = "cày thông thạo trái", Default = false})
...
local MasteryGun = Tabs.Main:AddToggle("MasteryGun", {Title = "Auto Mastery Gun", Description = "cày thông thạo súng", Default = false})
...
local MasterySword = Tabs.Main:AddToggle("MasterySword", {Title = "Auto Mastery All Sword", Description = "cày thông thạo tất cả kiếm", Default = false})
...
local Q = Tabs.Main:AddToggle("Q", {Title = "Auto Cake Prince", Description = "cày hoàng tử bột", Default = false})
Q:OnChanged(function(Value)
...
local Q = Tabs.Main:AddToggle("Q", {Title = "Auto Bones", Description = "cày xương", Default = false})
Q:OnChanged(function(Value)
...
local Q = Tabs.Main:AddToggle("Q", {Title = "Accept Quests", Description = "nhận nhiệm vụ", Default = false})
Q:OnChanged(function(Value)
  _G.AcceptQuestC = Value
end)          
local Q = Tabs.Main:AddToggle("Q", {Title = "Auto Farm Mirror", Description = "cày Mirror", Default = false})
Q:OnChanged(function(Value)
  _G.AutoMiror = Value
end)
spawn(function()
...
local Q = Tabs.Main:AddToggle("Q", {Title = "Auto Soul Reaper [Fully]", Description = "Cày Soul Reaper", Default = false})
Q:OnChanged(function(Value)
...
local Q = Tabs.Main:AddToggle("Q", {Title = "Auto Random Bones", Description = "random xương", Default = false})
Q:OnChanged(function(Value)
...
local Q = Tabs.Main:AddToggle("Q", {Title = "Auto Try Luck Gravestone", Description = "thử vận may", Default = false})
Q:OnChanged(function(Value)
  _G.TryLucky = Value
end)
spawn(function()
...
local Q = Tabs.Main:AddToggle("Q", {Title = "Accept Rainbow Quest Faster", Description = "Nhận nhiệm vụ cầu vồng nhanh hơn", Default = false})
Q:OnChanged(function(Value)
  _G.GetQFast = Value
end)

Tabs.Main:AddSection("Observation")
local Q = Tabs.Main:AddToggle("Q", {Title = "Auto Farm Observation", Description = "Cày haki né", Default = false})
Q:OnChanged(function(Value)
  _G.obsFarm = Value
end)
spawn(function()
...
local Q = Tabs.Main:AddToggle("Q", {Title = "Auto Observation V2", Description = "Lấy haki né v2", Default = false})
Q:OnChanged(function(Value)
...
local Q = Tabs.Main:AddToggle("Q", {Title = "Auto Upgrade Mink V3", Description = "Nâng tộc thỏ v3", Default = false})
Q:OnChanged(function(Value)
  _G.Auto_Mink = Value
end)
spawn(function()
...
local Q = Tabs.Main:AddToggle("Q", {Title = "Auto Upgrade Human V3", Description = "Nâng tộc người v3", Default = false})
Q:OnChanged(function(Value)
  _G.Auto_Human = Value
end)
spawn(function()
...
local Q = Tabs.Main:AddToggle("Q", {Title = "Auto Upgrade Skypiea V3", Description = "Nâng tộc thiên thần v3", Default = false})
Q:OnChanged(function(Value)
...
local Q = Tabs.Main:AddToggle("Q", {Title = "Auto Upgrade FishMan V3", Description = "Nâng tộc cá v3", Default = false})
Q:OnChanged(function(Value)
  _G.Auto_Fish = Value
end)
spawn(function()
...
Tabs.Main:AddSection("Rip_Indra Items")
local Q = Tabs.Main:AddToggle("Q", {Title = "Auto Valkyrie", Description = "Lấy mũ Rip_indra", Default = false})
Q:OnChanged(function(Value)
...
local Q = Tabs.Main:AddToggle("Q", {Title = "Auto Unlocked Puzzle", Description = "Mở khoá puzzle", Default = false})
Q:OnChanged(function(Value)
  _G.AutoUnHaki = Value
end)
...
local Initialize = Tabs.Settings:AddToggle("Initialize", {Title = "Fast Attack", Description = "Đánh nhanh", Default = true})
Initialize:OnChanged(function(Value)
  _G.Seriality = Value
end)
local Bringmob = Tabs.Settings:AddToggle("Bringmob", {Title = "Bring Mobs", Description = "Gom quái", Default = true})
Bringmob:OnChanged(function(Value)
  _B = Value
end)
local BusuAura = Tabs.Settings:AddToggle("BusuAura", {Title = "Auto Turn on Buso", Description = "Tự động cường hoá", Default = true})
...
local RaceV3Aura = Tabs.Settings:AddToggle("RaceV3Aura", {Title = "Auto Turn on Race V3", Description = "tự động bật tộc v3", Default = false})
...
local RaceV4Aura = Tabs.Settings:AddToggle("RaceV4Aura", {Title = "Auto Turn on Race V4", Description = "tự động bật tộc v4", Default = false})
...
local RandomAround = Tabs.Settings:AddToggle("RandomAround", {Title = "Anti Ban", Description = "Làm cho bạn nhìn giống player không gian lận và giảm chúng skill của kẻ địch", Default = true})
RandomAround:OnChanged(function(Value)
  RandomCFrame = Value
end)
local Byp = Tabs.Settings:AddToggle("Byp", {Title = "x2 Lucky", Description = "", Default = false})
Byp:OnChanged(function(Value)
  _G.Bypass = Value
end)
local SafeModes = Tabs.Settings:AddToggle("SafeModes", {Title = "Safe Mode", Description = "Giúp bạn không bị kẻ địch tiêu diệt", Default = false})
...
local UnDetectedAFK = Tabs.Settings:AddToggle("UnDetectedAFK", {Title = "Anti AFK", Description = "Tránh bị kick khi afk quá 20 phút", Default = true})
...
local DisblesVFX = Tabs.Settings:AddToggle("DisblesVFX", {Title = "Remove Hit VFX", Description = "Xoá hiệu ứng tấn công để giảm lag [khuyến khích cho mobile]", Default = true})
...
local DisblesVFX = Tabs.Settings:AddToggle("DisblesVFX", {Title = "Remove Death & Respawned VFX", Description = "Xoá hiệu ứng chết và hồi sinh để giảm lag [khuyến khích cho mobile]", Default = true})
DisblesVFX:OnChanged(function(Value)
  RDeath = Value
end)
spawn(function()
...
Tabs.Quests:AddSection("Law")
local Q = Tabs.Quests:AddToggle("Q", {Title = "Auto Law Sword", Description = "lấy kiếm law", Default = false})
Q:OnChanged(function(Value)
  _G.AutoLawKak = Value
end)
spawn(function()
...
Tabs.Quests:AddButton({Title = "Buy Microchip Law", Description = "mua chip law",
Callback = function()
  replicated.Remotes.CommF_:InvokeServer("BlackbeardReward","Microchip","2")
end})
Tabs.Quests:AddButton({Title = "Start Law Raids", Description = "bắt đầu raid law",
Callback = function()
  fireclickdetector(workspace.Map.CircleIsland.RaidSummon.Button.Main.ClickDetector)
end})

Tabs.Quests:AddSection("East Blue Misc")
local Q = Tabs.Quests:AddToggle("Q", {Title = "Auto Saw Sword", Description = "lấy cưa cá mập (sea1)", Default = false})
Q:OnChanged(function(Value)
  _G.AutoSaw = Value
end)
spawn(function()
...
local Q = Tabs.Quests:AddToggle("Q", {Title = "Auto Saber Sword", Description = "lấy saber (sea1)", Default = false})
Q:OnChanged(function(Value)
  _G.AutoSaber = Value
end)
spawn(function()
...
local Q = Tabs.Quests:AddToggle("Q", {Title = "Auto Lei Accessory", Description = "lấy phụ kiện Lei", Default = false})
Q:OnChanged(function(Value)
  _G.AutoKilo = Value
end)
spawn(function()
...
Tabs.Mirage:AddSection("Mirage Island / Full Moon")
...
local Q = Tabs.Mirage:AddToggle("Q", {Title = "Auto Find Mirage Island", Description = "Treo đảo và bay đến đảo nếu có", Default = false})
Q:OnChanged(function(Value)
  _G.FindMirage = Value
end)
spawn(function()
...
local Q = Tabs.Mirage:AddToggle("Q", {Title = "Auto Tween To Highest Point", Description = "Bay lên vị trí cao nhất", Default = false})
Q:OnChanged(function(Value)
...
local Q = Tabs.Mirage:AddToggle("Q", {Title = "Auto Collect Gear", Description = "Nhặt bánh răng=", Default = false})
Q:OnChanged(function(Value)
  _G.TPGEAR = Value
end)
spawn(function()
...
local Q = Tabs.Mirage:AddToggle("Q", {Title = "Auto Tween Advanced Fruit Dealer", Description = "Bay đến NPC bán trái ở Mirage", Default = false})
Q:OnChanged(function(Value)
  _G.Addealer = Value
end)
spawn(function()
...
local Q = Tabs.Mirage:AddToggle("Q", {Title = "Auto Collect Mirage Chest", Description = "Nhặt rương tại đảo Mirage", Default = false})
Q:OnChanged(function(Value)
  _G.FarmChestM = Value
end)
spawn(function()
...
Tabs.Mirage:AddSection("Skull Guitars")
...
local Q = Tabs.Mirage:AddToggle("Q", {Title = "Auto Skull Guitar", Description = "Tự động lấy Skull Guitar", Default = false})
Q:OnChanged(function(Value)
...
local Q = Tabs.Mirage:AddToggle("Q", {Title = "Auto Pull Lever", Description = "Gạt cần", Default = false})
Q:OnChanged(function(Value)
  _G.Lver = Value
end)
spawn(function()
...
local Q = Tabs.Mirage:AddToggle("Q", {Title = "Auto Train V4", Description = "Tự động cày luyện tộc v4", Default = false})
Q:OnChanged(function(Value)
  _G.AcientOne = Value
end)
spawn(function()
...
local Q = Tabs.Mirage:AddToggle("Q", {Title = "Auto Kill Player After Trial", Description = "Đánh người chơi trong trial", Default = false})
Q:OnChanged(function(Value)
  _G.Defeating = Value
end)
spawn(function()
...
Tabs.Drago:AddSection("Dojo Quest & Draco Race")
local DojoQ = Tabs.Drago:AddToggle("DojoQ", {Title = "Auto Dojo Trainer", Description = "Làm nhiệm vụ đai trắng đến đen", Default = false})
...
local BlazeEM = Tabs.Drago:AddToggle("BlazeEM", {Title = "Auto Dragon Hunter", Description = "Lấy Balze Ember", Default = false})
...
Tabs.Drago:AddSection("Draco Trial")
...
Toggle = Tabs.Drago:AddToggle("Toggle", {Title = "Tween To Upgrade Draco Trial", Description = "", Default = false})
Toggle:OnChanged(function(Value)
  _G.UPGDrago = Value
end)
spawn(function()
...
Toggle = Tabs.Drago:AddToggle("Toggle", {Title = "Auto Drago (V1)", Description = "Lấy tộc draco v1", Default = false})
Toggle:OnChanged(function(Value)
  _G.DragoV1 = Value
end)
spawn(function()
...
local fireflower = Tabs.Drago:AddToggle("fireflower", {Title = "Auto Drago (V2)", Description = "Lấy tộc draco v2", Default = false})
...
Toggle = Tabs.Drago:AddToggle("Toggle", {Title = "Auto Drago (V3)", Description = "Lấy tộc Draco v3", Default = false})
Toggle:OnChanged(function(Value)
  _G.DragoV3 = Value
end)
spawn(function()
...
Toggle = Tabs.Drago:AddToggle("Toggle", {Title = "Auto Relic Drago Trial [Beta]", Description = "tự động trial draco v4", Default = false})
Toggle:OnChanged(function(Value)
  _G.Relic123 = Value
end)
spawn(function()
...
Toggle = Tabs.Drago:AddToggle("Toggle", {Title = "Auto Train Drago v4", Description = "Cày luyện tộc draco", Default = false})
Toggle:OnChanged(function(Value)
  _G.TrainDrago = Value
end)
spawn(function()
...
local dragoTpVolcano = Tabs.Drago:AddToggle("dragoTpVolcano", {Title = "Tween to Drago Trials", Description = "Bay đến trỗ trial tộc draco", Default = false})
...
Toggle = Tabs.Prehistoric:AddToggle("Toggle", {Title = "Auto Craft Volcanic Magnet", Description = "tự động kiếm nguyên liệu và chế tạo nam châm núi lửa & dừng lại khi bạn có 1 nam châm núi lửa", Default = false})
Toggle:OnChanged(function(Value)
  _G.CraftVM = Value
end)
...
Vocan = Tabs.Prehistoric:AddToggle("Vocan", {Title = "Auto Find Prehistoric Island", Description = "Treo và bay đến đảo Prehistoric nếu có", Default = false})
...
local Vocan = Tabs.Prehistoric:AddToggle("Vocan", {Title = "Auto Patch Prehistoric Event", Description = "tự động vá núi lửa + tiêu diệt golem dung nham hào quang + tự động loại bỏ dung nham", Default = false})
Vocan:OnChanged(function(Value)
...
local Vocan = Tabs.Prehistoric:AddToggle("Vocan", {Title = "Auto Collect Dino Bones", Description = "Lấy xương khủng long", Default = false})
Vocan:OnChanged(function(Value)
  _G.Prehis_DB = Value
end)
spawn(function()
...
local Vocan = Tabs.Prehistoric:AddToggle("Vocan", {Title = "Auto Collect Dragon Eggs", Description = "Lấy xương rồng", Default = false})
Vocan:OnChanged(function(Value)
  _G.Prehis_DE = Value
end)
spawn(function()
...
Toggle = Tabs.Prehistoric:AddToggle("Toggle", {Title = "Auto Reset When Complete Volcano", Description = "Reset khi hoàn thành Núi lửa không thu thập được xương khủng long và các thứ khác", Default = false})
Toggle:OnChanged(function(Value)
  _G.ResetPH = Value
end)
spawn(function()
...
Tabs.SeaEvent:AddSection("Sea Event Settings")
...
Tabs.SeaEvent:AddButton({Title = "Buy Fracments with Spy", Description = "Mua chip Levi",
Callback = function()
...
local Q = Tabs.SeaEvent:AddToggle("Q", {Title = "Auto Teleport Frozen Dimension", Description = "Bay đến Frozen Dimension", Default = false})
Q:OnChanged(function(Value)
  _G.FrozenTP = Value
end)
spawn(function()
...
local Q = Tabs.SeaEvent:AddToggle("Q", {Title = "Auto Drive To Hydra Island", Description = "Lái thuyền về đảo Hydra", Default = false})
Q:OnChanged(function(Value)
...
Tabs.SeaEvent:AddButton({Title = "Buy Boats", Description = "Mua thuyền đã chọn",
Callback = function()
...
Tabs.SeaEvent:AddSection("Attack Sea Event")
...
Tabs.Raids:AddSection("Microchip / Raiding")
...
Tabs.Raids:AddButton({Title = "Buy Chips [Beli]", Description = "",
Callback = function()
  if not GetBP("Special Microchip") then replicated.Remotes.CommF_:InvokeServer("RaidsNpc","Select",_G.SelectChip) end
end})
Tabs.Raids:AddButton({Title = "Buy Chips [Blox Fruits]", Description = "Dùng trái yếu để mua chip",
Callback = function()
...
Tabs.Combat:AddSection("Player")
Q = Tabs.Combat:AddToggle("Q", {Title = "Instance Mink V3 [ INF ]", Description = "tộc thỏ v3 vô hạn", Default = false})
Q:OnChanged(function(Value)
  InfAblities = Value
end)
spawn(function()
...
Q = Tabs.Combat:AddToggle("Q", {Title = "Instance Energy [ INF ]", Description = "Năng lượng vô hạn", Default = false})
Q:OnChanged(function(Value)
  infEnergy = Value
  if Value then getInfinity_Ability("Energy", infEnergy) end
end)
Q = Tabs.Combat:AddToggle("Q", {Title = "Instance Soru [ INF ]", Description = "tốc biến vô hạn", Default = false})
Q:OnChanged(function(Value)
  _G.InfSoru = Value
  if Value then getInfinity_Ability("Soru", _G.InfSoru) end
end)
Q = Tabs.Combat:AddToggle("Q", {Title = "Instance Observation Range [ INF ]", Description = "Phạm vi quan sát cho haki quan sát vô cực", Default = false})
Q:OnChanged(function(Value)
...
Q = Tabs.Combat:AddToggle("Q", {Title = "Ignore Same Teams", Description = "không aim người chơi cùng đội", Default = false})
Q:OnChanged(function(Value)
  _G.NoAimTeam = Value
end)
Q = Tabs.Combat:AddToggle("Q", {Title = "Accept Allies", Description = "đồng ý đồng minh", Default = false})
Q:OnChanged(function(Value)
  _G.AcceptAlly = Value
end)
spawn(function()
...
GoIsland = Tabs.Travel:AddToggle("GoIsland", {Title = "Auto Travel", Description = "Bay đến đảo", Default = false})
...
GoNPCs = Tabs.Travel:AddToggle("GoNPCs", {Title = "Auto Tween to NPCs", Description = "Bay đến Npcs", Default = false})
...
RandomFF = Tabs.Fruit:AddToggle("RandomFF", {Title = "Auto Random Fruit", Description = "", Default = false})
...
DropF = Tabs.Fruit:AddToggle("DropF", {Title = "Auto Drop Fruit", Description = "Thả trái", Default = false})
...
StoredF = Tabs.Fruit:AddToggle("StoredF", {Title = "Auto Store Fruit", Description = "Lưu trái", Default = false})
...
TwF = Tabs.Fruit:AddToggle("TwF", {Title = "Auto Tween to Fruit", Description = "Lụm trái", Default = false})
...
BringF = Tabs.Fruit:AddToggle("BringF", {Title = "Auto Collect Fruit", Description = "Gom trái", Default = false})
...
UnPortal = Tabs.Misc:AddToggle("UnPortal", {Title = "Unlock All Portals", Description = "Mở khoá cổng dịch chuyển kể cả khi chưa đánh bại Rip_Indra", Default = true})
...
walkWater = Tabs.Misc:AddToggle("walkWater", {Title = "Turn on Walk on Water", Description = "Đi trên nước", Default = true})
...
iceWalk = Tabs.Misc:AddToggle("iceWalk", {Title = "Turn on Ice Walk", Description = "Đi trên nước nhưng có hiêuh ứng trái băng", Default = false})
